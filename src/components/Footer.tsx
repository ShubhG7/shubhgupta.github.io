  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 mt-2 sm:mt-0">
        <a href="https://www.instagram.com/shubhguptaaa/" target="_blank" rel="noopener" aria-label="Instagram" className="hover:scale-110 transition-transform">
          <svg width="24" height="24" fill="currentColor" className="text-pink-600" viewBox="0 0 24 24">
        ...
        <a href="https://github.com/ShubhG7" target="_blank" rel="noopener" aria-label="GitHub" className="hover:scale-110 transition-transform">
          <svg width="24" height="24" fill="currentColor" className="text-gray-700 dark:text-gray-200" viewBox="0 0 24 24">
        ...
        <a href="https://www.linkedin.com/in/shubhngupta/" target="_blank" rel="noopener" aria-label="LinkedIn" className="hover:scale-110 transition-transform">
          <svg width="24" height="24" fill="currentColor" className="text-blue-700 dark:text-blue-400" viewBox="0 0 24 24">
